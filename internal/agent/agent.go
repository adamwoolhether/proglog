...
// setupMux creates a listener on our RPC address that
// accepts gRPC and Raft connections. The mux accepts
// connections on the listener and matches connections
